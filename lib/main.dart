...
const sampleFileDict = {
  ...
  "Chinese": 'assets/squad_test_sample_zh.txt'
};
const itemsLanguage = [
  'English',
  'Japanese',
...
const fontDict = {
  ...
  "Russian": 'RobotoMono',
  'French': 'RobotoMono',
  'Chinese': 'Noto Sans Traditional Chinese',
};
const sentenceTextBoxError = {
  ...
  'Chinese': 'Please enter some text',
};
const sentenceTextBox = {
  ...
  'Chinese': 'Enter text or press `Example` below to try sample documents.',
};
const sentenceTextBoxHighlight = {
  ...
  'Chinese': '[Optional] Specify an answer from the text.',
};
...
const Desc = {
  ...
  'Chinese': 'Select LANGUAGE on the right top tab, TYPE into the text box, and click RUN to get question & answer generated by AI.'
};
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  _MyHomePageState() {
    ...
    loadAsset(sampleFileDict['Chinese']!).then((val) => setState(() {
      sampleListDict['Chinese'] = val.split("\n");
    }));
  }
